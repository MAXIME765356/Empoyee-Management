            ...
            MessageDialog{
                ...
                onYes: {
                    ...
                    //entered data goes to ListModel respectively,
                     if(database.insert( registerName.text, registerNo.text, registerWkh.text,((registerWkh.text*10.3)*30)))
                    {
                        console.log("Record Successfully")
                        registerName.text = "";
                        registerNo.text = "";
                        registerWkh.text = "";
                        maxModel.updateModel() // And updates the data model with a new record
